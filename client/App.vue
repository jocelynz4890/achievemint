...
<template>
  <header>
    <nav>
      ...
      <ul>
        <li v-if="isLoggedIn">
          <RouterLink :to="{ name: 'Collections' }" :class="{ underline: currentRouteName == 'Collections' }"> Collections </RouterLink>
        </li>
        <li v-if="isLoggedIn">
        ...
        <li v-if="isLoggedIn">
          <RouterLink :to="{ name: 'Settings' }" :class="{ underline: currentRouteName == 'Settings' }"> Profile & Settings </RouterLink>
        </li>
        <li v-else>
